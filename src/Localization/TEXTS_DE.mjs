...
export const TEXTS_DE = Object.freeze({
    ...
    [LOCALIZATION_KEY_SHOW_UPDATE_CONFIRM_MESSAGE]: "Eine neue Version von {name} ist verfügbar\nDas Update wird automatisch installiert, sobald alle Instanzen geschlossen sind\nDas Update kann versucht erzwungen zu werden, aber das könnte Konflikte verursachen, wenn mehere Instanzen exisitieren, und dauert möglicherweise bis zu einer Minute oder funktioniert möglicherweise nicht"
});
